...
import "./login.css";
import { APP_LOGO_IMG, LOGIN_BG_IMG } from "../constants/constants";
      ...
      <div className="bg-[rgba(0,0,0,0.7)] px-10 pt-10 pb-20 rounded-3xl">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          {isSignup && (
            <div className="mb-4">
              <p
                className={`passValid ${passvalidate.hasNumber ? "valid" : ""}`}
              >
              ...
              <p
                className={`passValid ${passvalidate.hasUpper ? "valid" : ""}`}
              >
                Contain atleast 1 uppercase
              </p>
              <p
                className={`passValid ${passvalidate.hasLower ? "valid" : ""}`}
              >
